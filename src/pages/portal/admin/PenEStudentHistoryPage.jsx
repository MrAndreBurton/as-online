...
import {
  fetchPenEStudentHistory,
  fetchPenEStudentHistoryFilters,
...
export default function PenEStudentHistoryPage() {
  const { studentId } =
    useParams();
  ...
  return (
    <>
      ...
      <section className="pen-e-student-metric-grid">
        <article className="pen-e-student-metric">
          <strong>
            {Number(
              metrics?.sessions ??
                0
      ...
      <section className="portal-card pen-e-student-history-browser">
        ...
        <form
          className="pen-e-student-history-search"
          onSubmit={
            submitSearch
          }
        >
          <input
            ...
            placeholder="Search session, Offering or tutor…"
            onChange={(
              event
            ) =>
              setSearchInput(
        ...
        <div className="pen-e-student-history-filters">
          <select
            value={
              offeringId
            }
        ...
        {loading ? (
          ...
          <div className="aeos-table-wrap">
            <table className="aeos-table pen-e-student-history-table">
              <thead>
                <tr>
                  <th>
                    Date
                  ...
                  (session) => {
                    ...
                    return (
                      <tr
                        ...
                        className="pen-e-student-session-row"
                        tabIndex={0}
                        onClick={() =>
                          navigate(
